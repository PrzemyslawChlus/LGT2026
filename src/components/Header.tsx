        ...
        <div className="flex items-center justify-between gap-2.5 sm:gap-4">
          ...
          <div className="flex items-center gap-1.5 sm:gap-3 shrink-0">
            ...
            <button
              ...
              className="relative inline-flex items-center justify-center p-2 rounded-xl bg-emerald-900/80 hover:bg-emerald-800 text-stone-200 hover:text-white border border-emerald-800 hover:border-amber-400/40 transition-colors cursor-pointer"
              title="Powiadomienia ligowe (mecze i wyniki)"
              aria-label="Powiadomienia ligowe"
            >
              <Bell className="w-4 h-4 text-lime-400" />
              {unreadNotificationsCount > 0 ? (
                <span className="absolute -top-1 -right-1 px-1.5 min-w-[18px] h-[18px] flex items-center justify-center rounded-full text-[10px] font-black bg-lime-400 text-emerald-950 border border-emerald-950 shadow-xs animate-pulse">
                  {unreadNotificationsCount > 9 ? '9+' : unreadNotificationsCount}
                </span>
              ) : !hasNotificationPermission ? (
                <span
                  className="absolute top-1 right-1 w-2 h-2 rounded-full bg-amber-400 border border-emerald-950"
                    ...
                    <div className="p-1.5 space-y-0.5 text-xs">
                      ...
                      >
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            <span className="font-bold block text-stone-900">Powiadomienia i alerty</span>
                            <span className="text-[10px] text-stone-400 block">Ustawienia push, historia alertów</span>
                          </div>
                        </div>
                        {unreadNotificationsCount > 0 && (
                          <span className="px-2 py-0.5 rounded-full text-[10px] font-black bg-lime-400 text-emerald-950">
