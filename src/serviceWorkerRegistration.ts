...
/**
 * Returns active service worker registration or registers /sw.js for web push notifications.
 */
export async function getServiceWorkerRegistration(): Promise<ServiceWorkerRegistration | null> {
  ...
  try {
    ...
    console.warn('[SW] Could not obtain service worker registration for notifications:', err);
    return null;
  }
}
