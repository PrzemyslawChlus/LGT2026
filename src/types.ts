...
// Deprecated type alias for backwards compatibility during migration (passwordHash completely removed)
...
export interface LeagueNotification {
  ...
  recipientPlayerIds: string[]; // Player IDs targeted by this notification
  matchId?: string;
  createdAt: number;
  url?: string;
  readBy?: string[]; // Player or User IDs who marked this notification as read
}
